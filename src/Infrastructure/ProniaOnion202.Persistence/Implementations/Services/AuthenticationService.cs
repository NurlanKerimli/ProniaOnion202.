...
using ProniaOnion202.Application.Abstraction.Handlers;
...
using IAuthenticationService = ProniaOnion202.Application.Abstraction.Services.IAuthenticationService;
...
namespace ProniaOnion202.Persistence.Implementations.Services
{
    public class AuthenticationService : IAuthenticationService
	{
		...
		{
			if (await _userManager.Users.AnyAsync(u => u.UserName == dto.UserName || u.Email == dto.Email)) throw new Exception("There is a product with the same name.");
